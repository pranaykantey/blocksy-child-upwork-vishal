...
function save_product_meta($post_id)
{
    ...
    $num_products = get_post_meta($post_id, 'num_products', true) ? get_post_meta($post_id, 'num_products', true) : 1;
    $num_products = (int) $num_products;
...
function enqueue_admin_scripts($hook)
{
    ...
    if ($hook == 'post.php' || $hook == 'post-new.php') {
        ...
        wp_enqueue_script('admin-custom', get_stylesheet_directory_uri() . '/admin-custom.js', array('jquery'), '1.0', true);
