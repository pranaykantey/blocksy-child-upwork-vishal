    ...
    foreach ($fields as $key => $field) {
        ...
        switch ($field['type']) {
            ...
            case 'image':
                ...
                if ($value) {
                    echo "<img src='" . esc_url($value) . "' alt='Preview'>";
                }
                echo "</div>";
                break;
            case 'color':
...
function save_custom_fields($post_id) {
    ...
    $all_possible_fields = array(
        ...
        'back_to_top_text', 'num_products', 'sidebar_1_title', 'sidebar_1_subtitle',
        'sidebar_1_image_1', 'sidebar_1_image_2', 'sidebar_2_title', 'sidebar_2_subtitle',
        'sidebar_2_link_title_top5', 'primary_color', 'secondary_color', 'tertiary_color'
    );
    ...
    for ($i = 1; $i <= $num_products; $i++) {
        $all_possible_fields = array_merge($all_possible_fields, array(
            ...
            "product_{$i}_rating_image", "product_{$i}_grade", "product_{$i}_pros", "product_{$i}_cons",
