...
$GLOBALS['common_fields'] = array(
    'num_products',
    'logo_url', 'author_image', 'author_name', 'site_name', 'site_url'
);
...
$GLOBALS['product_comparison_fields'] = array(
    'disclosure_top', 'subtitle', 'benefits_nav_text', 'ingredients_nav_text', 'top_5_nav_text',
    'disclosure', 'effect_image', 'benefits_title', 'benefits_content', 'usage_title',
    'usage_content', 'ingredients_to_look_for_title', 'ingredients_to_look_for_content',
    'ingredients_to_avoid_title', 'ingredients_to_avoid_content', 'considerations_title',
    'considerations_content', 'top_products_title', 'citations_title', 'citations',
    'back_to_top_text'
);
...
function product_comparison_fields($post) {
    ...
    echo '<h3>Sidebar Information</h3>';
...
function save_product_meta($post_id) {
    ...
    $fields_to_save = array(
        // Common fields
        'num_products', 'logo_url', 'author_image', 'author_name', 'site_name', 'site_url',

        // Product Review fields
        'best_product_category', 'sidebar_ad_image', 'intro_headline', 'intro_paragraph',
        'conclusion_headline1', 'conclusion_para1', 'conclusion_image1', 'conclusion_para2',
        'conclusion_headline2', 'conclusion_para3', 'conclusion_image2', 'conclusion_para4',
        'cta_text', 'cta_link',
        ...
        'ingredients_to_avoid_title', 'ingredients_to_avoid_content', 'considerations_title',
        'considerations_content', 'top_products_title', 'citations_title', 'citations',
        'back_to_top_text', 'sidebar_1_title', 'sidebar_1_subtitle', 'sidebar_1_image_1',
        'sidebar_1_image_2', 'sidebar_2_title', 'sidebar_2_subtitle', 'sidebar_2_link_title_top5',
    ...
    for ($i = 1; $i <= $num_products; $i++) {
        $product_fields = array(
            'name', 'brand', 'link', 'image', 'rating_image', 'grade', 'pros', 'cons', 'bottom_line',
            'rating', 'effectiveness', 'safety', 'price', 'description'
        );
        foreach ($product_fields as $field) {
            $key = "product_{$i}_{$field}";
            if (isset($_POST[$key])) {
                $value = in_array($field, array('pros', 'cons', 'bottom_line', 'description')) 
...
function save_product_comparison_meta($post_id) {
    $fields = array(
        ...
        'ingredients_to_avoid_title', 'ingredients_to_avoid_content', 'considerations_title',
        'considerations_content', 'top_products_title', 'citations_title', 'citations',
        'back_to_top_text', 'sidebar_1_title', 'sidebar_1_image_1', 'sidebar_1_image_2',
        'sidebar_1_subtitle', 'sidebar_2_title', 'sidebar_2_subtitle', 'sidebar_2_icon_1',
        'sidebar_2_icon_2', 'sidebar_2_icon_3', 'sidebar_2_icon_4', 'sidebar_2_icon_5', 'sidebar_2_icon_6'
    );
...
function enqueue_admin_scripts($hook) {
    ...
    if ($hook == 'post.php' || $hook == 'post-new.php') {
        wp_enqueue_media();
        wp_enqueue_script('product-admin-script', get_stylesheet_directory_uri() . '/js/product-admin.js', array('jquery'), '1.0', true);
...
function register_custom_fields_for_api() {
    ...
    for ($i = 1; $i <= 10; $i++) {
        $product_fields = array(
            "product_{$i}_name", "product_{$i}_brand", "product_{$i}_link", "product_{$i}_image",
            "product_{$i}_rating_image", "product_{$i}_grade", "product_{$i}_pros",
            "product_{$i}_cons", "product_{$i}_bottom_line", "product_{$i}_rating",
