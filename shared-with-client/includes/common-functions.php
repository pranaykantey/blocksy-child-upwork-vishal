...
// function before
// function add_utm_to_link($link)
// {
//     $ecommerce_domains = array('eb5.com', 'sandandsky.com', 'mineralstream.co', 'mineralstream.com', 'stone-stream.com', 'kerafiber.com', 'skinnymint.com');
//     $current_domain = parse_url(home_url(), PHP_URL_HOST);
//     $url_parts = parse_url($link);

//     if (isset($url_parts['host'])) {
//         $host_parts = explode('.', $url_parts['host']);
//         $domain = implode('.', array_slice($host_parts, -2, 2)); // Get the last two parts of the domain

//         if (in_array($domain, $ecommerce_domains)) {
//             $link = add_query_arg(array(
//                 'utm_source' => $current_domain,
//                 'utm_medium' => 'referral',
...
function add_utm_to_links_to_content($content)
{
    // Add UTM parameters
    $current_domain = parse_url(home_url(), PHP_URL_HOST);
...
add_filter('the_content', 'add_utm_to_links_to_content');
